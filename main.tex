...
\begin{persian}
	...
	\begin{frame}{اهمیت}
		\begin{itemize}\RTList{}
			\justifying%
			\item کیفیت سرویس انتها به انتها یک زنجیره در واقعا معیار کارآیی است که توسط کاربران احساس می‌شود.
	...
	%-------------------------------------------------------------------------------
	\begin{frame}{شبکه‌های قطعی}
		\begin{itemize}\RTList{}
			\justifying%
			\item \textcolor{green}{Deterministic Networks}
		  	\item \textcolor{orange}{تضمین} یک کران بالا برای تاخیر
		\end{itemize}
	\end{frame}
